...
<form class="form-horizontal templatemo-contact-form-1" role="form" action="/yuyue/admin.php/Home/Admin/creat" method="post">
<input type='hidden' name='id' value='<?php echo ($data["id"]); ?>'>
				<div class="form-group">
					<div class="col-md-12">
						<h1 class="margin-bottom-15">添加医院信息</h1>
						<p>请填写相关信息.</p>
					</div>
				</div>				
		        <div class="form-group">
		          <div class="col-md-12">		          	
		            <label for="name" class="control-label">医院名称 *</label>
